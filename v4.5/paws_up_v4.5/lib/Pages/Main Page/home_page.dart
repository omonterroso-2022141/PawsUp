...
class _HomePageState extends State<HomePage>
  ...
  String _appBarTitle = 'PawsUp'; // Título inicial
  ...
  void _onItemTapped(int index) {
    _controller.reverse().then((_) {
      setState(() {
        ...
        // Cambiar el título cuando se selecciona el índice 1 (PawsMap)
        _appBarTitle = index == 1 ? 'PawsMap' : 'PawsUp';
      });
      _controller.forward();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          _appBarTitle, // Usar el título dinámico
          style: TextStyle(
            color: Colors.white,
            fontFamily: 'Meow',
            fontSize: 45,
        ...
        actions: _selectedIndex == 4
          ...
          IconButton(
            ...
            : [
          IconButton(
            icon: const Icon(Icons.pets_outlined, color: Color(0xFF5BFFD3)),
