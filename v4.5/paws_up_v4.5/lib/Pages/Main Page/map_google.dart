...
class _MapGoogleState extends State<MapGoogle>
  ...
  // Antes de la clase _MapGoogleState, define la función asíncrona para obtener el BitmapDescriptor
  Future<BitmapDescriptor> _getMarkerIcon() async {
    final ImageConfiguration config = ImageConfiguration(size: Size(2, 2)); // Tamaño del marcador (24x24)
...
// En la función _addMascotasMarkers, utiliza el BitmapDescriptor obtenido directamente
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Buscar...', style: TextStyle(
            fontFamily: "Hey",
            color: Color(0xFF5BFFD3),
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.search, color: Color(0xFF5BFFD3)), // Icono de búsqueda en blanco
            onPressed: _handleSearch,
          ),
          IconButton(
            icon: Icon(Icons.layers, color: Color(0xFF5BFFD3)), // Icono de capas en rojo
            onPressed: () {
              setState(() {
